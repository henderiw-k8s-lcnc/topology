...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *TemplateNetwork) DeepCopyInto(out *TemplateNetwork) {
	*out = *in
	in.SupportServers.DeepCopyInto(&out.SupportServers)
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new TemplateNetwork.
func (in *TemplateNetwork) DeepCopy() *TemplateNetwork {
	if in == nil {
		return nil
	}
	out := new(TemplateNetwork)
	in.DeepCopyInto(out)
	return out
}
